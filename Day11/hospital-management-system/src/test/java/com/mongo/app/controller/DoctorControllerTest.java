...
public class DoctorControllerTest {
    ...
    public void readAppointmentsTest(){
        ...
        dummyAppointment.setAppointmentId(123);
        dummyAppointment.setPatientName("ABC");
        dummyAppointment.setDoctorName("XYZ");
        dummyAppointment.setDate("6 Sept");
        ...
        List<Appointment> result = appointmentRepository.findByDoctorName("XYZ");
